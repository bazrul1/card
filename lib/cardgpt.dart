...
class Cardgpt extends StatefulWidget {
  const Cardgpt({ Key? key }) : super(key: key);

  @override
  _CardgptState createState() => _CardgptState();
}

class _CardgptState extends State<Cardgpt> {
  @override
